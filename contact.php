...
/* Style inputs */
.body input[type=text], select, textarea, input[type=email]  {
 width: 100%;
padding: 12px;
	...
	<div class="navbar">
		...
		<div class="body" >
			...
			<center><h1><b>Contact Us</b></h1></center>
						...
						<form  method="post" class ="form" onsubmit="check()" action="contact.php" >
						<?php include ('errors.php') ?>
							<label for="fname">First Name</label><input type="text" id="fname" name="firstname" placeholder="Your name.." required><br>
							<label for="lname">Last Name</label>
							<input type="text" id="lname" name="lastname" placeholder="Your last name.." required><br>
							<label for="lname">Email ID</label>
							<input type="email" id="emailid" name="EmailID" placeholder="Your Email ID.." pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="emailaddress@domainname.com "  required><br>
