...
<div class="header">
  ...
  <a href="staff_profile.php?logout='1'">Log Out</a>
</div>	  
				  <div id="main">
...
<center> <h3><table>
	<tr>
		<th>Staff ID: </th>
		<td><?php echo $displayStaffID ?> </td>	  
		<th>Action: </th>
		<td>
		
			<a href="staff_editmyprofile.php?edit=<?php echo $displayStaffID; ?>"> Edit</a>
		</td>		
	</tr>
	<tr>
		<th>First Name: </th>
		<td><?php echo $displayStaffFName ?> </td>
		
	</tr>
	
	<tr>
		<th>Last Name: </th>
		<td><?php echo $displayStaffLName ?> </td>	  	
	</tr>
	
	<tr>
	<th>DOB: </th>
	<td><?php echo $displayStaffdob ?> </td>
	</tr>
	
	<tr>
	<th>Username: </th>
	<td><?php echo $displayStaffUsername ?> </td>
	</tr>
	
	<tr>
	<th>Password: </th>
	<td><?php echo $displayStaffPassword ?> </td>
	</tr>
	
	<tr>
	<th>E-mail: </th>
	<td><?php echo $displayStaffEmail ?> </td>
	</tr>
	
	<tr>
	<th>Mobile Number: </th>
	<td><?php echo $displayStaffmobile ?> </td>
	</tr>
