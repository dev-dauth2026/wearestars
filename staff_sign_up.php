...
<div class="header">
  ...
  <a href="staff_sign_up.php?logout='1'">Log Out</a>
</div>	  
				  <div id="main">
...
<form name="frmStaffSignUp" onsubmit="return check()" action="staff_sign_up.php" method="post" >
...
<h1>Staff Sign Up Form</h1>
  ...
  <div class="container">
	...
	<label for="firstname"><b>User First Name</b></label><br>
    <input type="text" placeholder="Enter First Name" name="staffFirstName" required><br><br>
	
	<label for="Last Name"><b>User Last Name</b></label><br>
    <input type="text" placeholder="Enter Last Name" name="staffLastName" required><br><br>
	
	<label for="DOB"><b>DOB</b></label><br>
    <input type="text" placeholder="Enter DOB" name="staffDOB" required><br><br>
	
	<label for="mobile number"><b>Mobile Number</b></label><br>
    <input type="text" placeholder="Enter Mobile Number" name="staffMobileNumber" required><br><br>

    <label for="email"><b>Email</b></label><br>
    <input type="text" placeholder="Enter Email" name="staffEmail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="name@domain.com" required><br><br>
	
	<label for="psw"><b>Username</b></label><br>
    <input type="text" id="staffUsername" placeholder="Enter Username" name="staffUsername" required><br><br>

    <label for="psw"><b>Password</b></label> <span id="messages" style="color:red"> </span><br>
    <input type="password" id="staffpassword"  placeholder="Enter Password" name="staffPassword" required><br><br>

    <label for="psw-repeat"><b>Repeat Password</b></label> <br></br>
    <input type="password" id="staffrepeatpassword" placeholder="Repeat Password" name="staffpsw-repeat" onchange="check()" required><br><br>
    
      <input type="checkbox" name="terms" required> I accept terms and conditions <br> <br>
	  <input type="checkbox" checked="checked" name="staffremember" style="margin-bottom:15px"> Remember me<br><br>
    ...
    <div class="clearfix">
      ...
      <button type="submit" class="signupbtn" name="staffsignup">Sign Up</button>
    </div>
  </div>
</form></center>
</div>
...
function myFunction() {
  window.open("staffmanagement.php");
}

function check(){
	password1=document.getElementById("staffpassword").value;
	password2=document.getElementById("staffrepeatpassword").value;
	if (password1!=password2){
	
		document.getElementById('staffrepeatpassword').style.color = 'red';
		document.getElementById("messages").innerHTML = "   ** Please, Enter same password.";
