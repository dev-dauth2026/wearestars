...
<a class="active" href="#">Welcome</a>
  ...
  <a href="client_welcome.php?logout='1'">Log Out</a>
</div>	  
				  <div id="main">
...
<?php endif ?>
<center><h1 style="font-size:40px;">Welcome  <strong><?php echo $_SESSION['username']; ?></strong></h1><br><br><br>
 <p> Thank you '<strong><?php echo $_SESSION['username']; ?></strong>' for successfully Sign In as Client <br>Please find yourself connected with our platform.<br>
 You can costomise  your profile and blogs. </center>
