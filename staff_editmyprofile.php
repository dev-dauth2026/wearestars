...
<div class="header">
  ...
  <a href="staff_editmyprofile.php?logout='1'">Log Out</a>
</div>	  
				  <div id="main">
...
<div class="content">
<center>
 <form name="frmStaffEditMyProfile" onsubmit="return check()" method="post" action="staff_editmyprofile.php" >
 ...
 <div class="container"><br><br>
	...
	<label> Confirm Password:</label><span id="messages" style="color:red"> </span><br>
		<input type="password" id="staffConfirmpassword" name="staffConfirmpassword"   required > <br> <br>
	...
	<input type="checkbox" name="terms" required> I accept terms and conditons <br> <br>
		<button class="btnCancel" type="button" name="cancel"><a href="staff_profile.php">Cancel</a></button>
		<button type="submit" name="staff-editmyprofile" value="Save" class="btnSave">Save</button>
		</div>
	</form>
		</center>
</div>
